...
The original negative-control run reported 41 failures including failed
subtests. Coverage includes four successive IRQ periods, nonzero
...
host-performance optimization. It was excluded from the earlier live
flag-path speed measurements. Unit regressions are not proof of full-game timing
